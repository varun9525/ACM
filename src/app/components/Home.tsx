    ...
    <div className="bg-[#050510] text-white overflow-hidden" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          ...
          >
            <Link to="/events" className="group relative inline-flex items-center gap-2 px-8 py-4 rounded-xl overflow-hidden" style={{ fontSize: 15, fontWeight: 600 }}>
      ...
      <section className="py-28 relative">
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group relative inline-flex items-center gap-2 px-10 py-5 rounded-2xl overflow-hidden"
